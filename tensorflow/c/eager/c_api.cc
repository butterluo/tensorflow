...
TFE_Context* TFE_NewContext(const TFE_ContextOptions* opts, TF_Status* status) {
  ...
  tensorflow::Rendezvous* r =
      new tensorflow::IntraProcessRendezvous(device_mgr.get());//BT通信进程内 'RefCountedIntraProcessRendezvous is aliased to IntraProcessRendezvous for'
...
#if !defined(IS_MOBILE_PLATFORM)
  eager_context->SetDistributedManager(//BT分布式
